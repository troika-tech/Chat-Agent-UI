...
const Input = styled.input`
  ...
  &:focus {
    ...
    box-shadow: ${props => props.$isDarkMode
      ? '0 0 0 5px rgba(139, 92, 246, 0.2), 0 8px 24px rgba(139, 92, 246, 0.15), inset 0 2px 6px rgba(0, 0, 0, 0.15)'
      : '0 0 0 5px rgba(139, 92, 246, 0.12), 0 8px 24px rgba(139, 92, 246, 0.1), inset 0 2px 6px rgba(0, 0, 0, 0.04)'
    };
...
const AuthModal = ({
  ...
  return (
    <ModalOverlay $isDarkMode={isDarkMode}>
        ...
        <RightPanel>
          {!showOtpInput ? (
            <RightPanelContent key="phone-form">
              <FormHeader>
                <FormTitle $isDarkMode={isDarkMode}>Welcome Back</FormTitle>
                <FormSubtitle $isDarkMode={isDarkMode}>
                  Please verify your WhatsApp number to get started securely
                </FormSubtitle>
              </FormHeader>
            ...
            <RightPanelContent key="otp-form">
              <FormHeader>
